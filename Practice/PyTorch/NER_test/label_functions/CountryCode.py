"""
CountryCodes fork from https://parserv2--templates-accordproject.netlify.app/supplyagreement-perishable-goods@0.15.0.html
"""
...
"FK", # Falkland Islands (Malvinas) 1974  .fk ISO 3166-2:FK ISO country name follows UN designation due to the Falkland Islands sovereignty dispute (local common name: Falkland Islands)[15]
...
"GB", # United Kingdom of Great Britain and Northern Ireland  1974  .gb (.uk) ISO 3166-2:GB Code taken from Great Britain (from official name: United Kingdom of Great Britain and Northern Ireland)[16] .uk is the primary ccTLD of the United Kingdom instead of .gb (see code UK, which is exceptionally reserved)
...
"TW", # Taiwan, Province of China 1974  .tw ISO 3166-2:TW Covers the current jurisdiction of the Republic of China ISO country name follows UN designation (due to political status of Taiwan within the UN)[16] (common name: Taiwan)
...
def is_CountryCode(text):
    return text in CountryCodeISOAlpha2